      ...
      <div className='addrecipe-content'>
        ...
        <main className='addrecipe-main-content'>
          <form id="recipe-inputs" onSubmit={submitRecipe}>
            ...
            <div className="meal-buttons">
              <button onClick={(e) => handleMealTypeClick('Breakfast', e)}>
                Breakfast
              </button>
              <button onClick={(e) => handleMealTypeClick('Lunch', e)}>
                Lunch
              </button>
              <button onClick={(e) => handleMealTypeClick('Dinner', e)}>
                Dinner
              </button>
              <button onClick={(e) => handleMealTypeClick('Snack', e)}>
                Snack
              </button>
            </div>
