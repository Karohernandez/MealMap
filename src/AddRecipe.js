...
const AddRecipe = () => {
  ...
  const addIngredient = (e) => {
    e.preventDefault();
    setIngredients(prevIngredients => [...prevIngredients, { name: currentIngredient, quantity: currentQuantity, unit: currentUnit }]);
  ...
  const addRestriction = (e) => {
    ...
    if (!restrictions.includes(currentRestriction)) {
      setRestrictions(prevRestrictions => [...prevRestrictions, currentRestriction]);
    }
  };
  ...
  const handleMealTypeClick = (type, e) => {
    e.preventDefault();
    setMealType(type);
  };
  ...
  return (
    <div className="addrecipe-mealmap-container">
      ...
      <div className='addrecipe-content'>
        ...
        <main className='addrecipe-main-content'>
          <form id="recipe-inputs" onSubmit={submitRecipe}>
            ...
            <div className="meal-buttons">
              <button className="breakfast-button meal-button" onClick={(e) => handleMealTypeClick('Breakfast', e)}>
                <b>Breakfast</b>
              </button>
              <button className="lunch-button meal-button" onClick={(e) => handleMealTypeClick('Lunch', e)}>
                <b>Lunch</b>
              </button>
              <button className="dinner-button meal-button" onClick={(e) => handleMealTypeClick('Dinner', e)}>
                <b>Dinner</b>
              </button>
              <button className="snack-button meal-button" onClick={(e) => handleMealTypeClick('Snack', e)}>
                <b>Snack</b>
              </button>
            </div>
